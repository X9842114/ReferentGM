      ...
      <div className="relative mx-auto w-full max-w-2xl">
        ...
        >
          <div className="space-y-3 text-center">
            ...
            >
              <p className="mb-2 text-sm tracking-[0.2em] text-white/40 uppercase">
                RefGM
              </p>
              <h1 className="pb-1 text-3xl font-semibold tracking-tight text-white">
          ...
          >
            ...
            <div className="p-4">
              <Textarea
                ...
                placeholder="Ask RefGM a question..."
